    ...
    <div style={{ minHeight: '100vh', display: 'flex', alignItems: 'center', justifyContent: 'center', backgroundColor: '#0a0a0f' }}>
      <div style={{ width: '100%', maxWidth: '400px', backgroundColor: '#111118', borderRadius: '12px', border: '1px solid #2e2e3e', padding: '40px' }}>
        <div style={{ textAlign: 'center', marginBottom: '32px' }}>
          ...
          <h1 style={{ color: 'white', fontSize: '24px', fontWeight: 'bold', margin: 0 }}>Create your account</h1>
          <p style={{ color: '#888', marginTop: '8px' }}>Start managing tasks with FairList</p>
        </div>
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: '12px', marginBottom: '20px' }}>
          ...
          <span style={{ color: '#666', fontSize: '13px' }}>or sign up with email</span>
          <div style={{ flex: 1, height: '1px', backgroundColor: '#2e2e3e' }}></div>
        </div>
        ...
        <form onSubmit={handleSignup}>
          <div style={{ marginBottom: '16px' }}>
            <label style={{ display: 'block', color: '#aaa', fontSize: '14px', marginBottom: '6px' }}>Full Name</label>
            <input
              type="text"
              value={fullName}
        ...
        <div style={{ textAlign: 'center', marginTop: '24px' }}>
          <p style={{ color: '#666', fontSize: '14px' }}>
            ...
            <Link href="/login" style={{ color: '#7c6dfa', textDecoration: 'none' }}>Sign in</Link>
          </p>
        </div>
      </div>
    </div>
