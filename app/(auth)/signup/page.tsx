...
export default function SignupPage() {
  ...
  return (
    <div style={{
      ...
      justifyContent: 'center', padding: '24px', background: '#0a0a0f',
    }}>
      <div style={{ width: '100%', maxWidth: 400 }}>

        <div style={{ textAlign: 'center', marginBottom: 32 }}>
          <div style={{
            width: 48, height: 48, borderRadius: 14, background: '#7c6dfa',
          ...
          <p style={{ color: '#8888a0', fontSize: 14, margin: 0 }}>Start managing your tasks today</p>
        </div>
        ...
        <div style={{
          ...
          <form onSubmit={handleSignup}>
            <div style={{ marginBottom: 18 }}>
              <label style={{ display: 'block', color: '#c0c0d8', fontSize: 13, fontWeight: 500, marginBottom: 7 }}>Full name</label>
              <input type="text" value={fullName} onChange={e => setFullName(e.target.value)}
                required placeholder="Jane Doe" style={inputStyle}
            ...
            <div style={{ marginBottom: 22 }}>
              <label style={{ display: 'block', color: '#c0c0d8', fontSize: 13, fontWeight: 500, marginBottom: 7 }}>Password</label>
              <input type="password" value={password} onChange={e => setPassword(e.target.value)}
                required placeholder="Min 6 characters" minLength={6} style={inputStyle}
                onFocus={e => (e.target.style.borderColor = '#7c6dfa')}
                onBlur={e => (e.target.style.borderColor = '#2e2e3e')} />
            </div>
            ...
            <button type="submit" disabled={loading} style={{
              ...
              background: loading ? '#5a4ec0' : '#7c6dfa', color: '#ffffff',
          ...
          <div style={{ textAlign: 'center' }}>
            <span style={{ color: '#8888a0', fontSize: 13 }}>Already have an account? </span>
            <Link href="/login" style={{
              color: '#ffffff', fontSize: 13, fontWeight: 600,
              textDecoration: 'none', background: '#2e2e3e',
              padding: '6px 14px', borderRadius: 8,
              border: '1px solid #3e3e50', marginLeft: 8,
            }}>
              Sign in →
            </Link>
          </div>
